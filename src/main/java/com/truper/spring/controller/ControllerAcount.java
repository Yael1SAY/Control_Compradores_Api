...
import com.truper.spring.auth.InfoAdicionalToken;
...
public class ControllerAcount {
    ...
    public Comprador login(@RequestParam("user") String username, @RequestParam("password") String pwd) {

        String token = getJWTToken(username);
        Comprador user = new Comprador();
        user.setClave(username);
